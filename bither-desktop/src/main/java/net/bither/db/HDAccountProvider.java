...
public class HDAccountProvider implements IHDAccountProvider {
   ...
   // @Override
	...
	@Override
	public int addHDAccount(String encryptedMnemonicSeed, String encryptSeed, String firstAddress, boolean isXrandom,
			String addressOfPS, byte[] externalPub, byte[] internalPub) {
